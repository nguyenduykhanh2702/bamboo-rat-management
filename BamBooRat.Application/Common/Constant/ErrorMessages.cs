...
{
    public const string DuplicateRatByName = "Tên dúi đã tồn tại";
    ...
    public const string BreedingOnlyOne = "Chuồng sinh sản chỉ được 1 con";
    public const string CannotMixBaby = "Không được nuôi chung baby và dúi sinh sản";
}